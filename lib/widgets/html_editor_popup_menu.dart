        ...
        return [
          ...
          if (showPerfOverlay)
            PopupMenuItem(
              ...
              child: _CheckBoxMenuItem('showPerformanceOverlay', value.showPerformanceOverlay),
            ),
          if (toggleIsSelectable)
            PopupMenuItem(
              value: _PopupMenuValue.toggleIsSelectable,
              child: _CheckBoxMenuItem('isSelectable',value.isSelectable),
            ),
        ];
      },
    );
...
class _PopupMenuState {
  ...
  final GlobalKey<HtmlWidgetState> key = GlobalKey<HtmlWidgetState>();
